...
public class Charaktererstellung {
    ...
    public Charaktererstellung(int stage) {
        ...
        if (stage == 1) {//intro
            ...
            build.append("In this world you are a 19 Years old Soldier, who just signed for his First  offizial Mission.\n Your name is ...");
            build.append(" ... ");
        }
        ...
        if (stage == 2 ) {//intro to surroundings
            ...
            build.append("You live in a devided world ");
            build.append("With the Humands there are also living many different Species on this world:\n\n");
